...
Current version: **1.0.8** · MIT · [LICENSE](LICENSE)
...
Download the latest signed and notarized Mac build from [GitHub Releases](https://github.com/JewhurstEngineering/ai-meter/releases/latest/download/AIMeter-1.0.8.zip).
